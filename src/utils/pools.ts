...
export const LIQUIDITY_POOLS: LiquidityPoolInfo[] = [
  ...
  },
  {
    ...
    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: 'CcjiVqYn7aB98XSfufnVEqEVJqieSZLcCT8xftyWnKf6',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: '4y2FyyZELHNLrF6uXYJF21LJGfeo2UxDP9Dv1HeAogmy',
    ammTargetOrders: '9nTFujrwcrHiwd5i3rfBjz9d1by2WnDzked9K2XJ1dwV',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: 'J7BHxpYBsyGUrTe9M8vKRddgjxN2eBJ4QLHzC3PNnxMH',
    poolPcTokenAccount: 'HDTpW4xm162To8UmBiuAqSzhrNyogkJjNgJueGtnC4H8',
    poolWithdrawQueue: '49as7xwDtYxWVSoVzuYHRQrfi4yhPKkZmHY5pbnkXHqo',
    poolTempLpTokenAccount: '96g6TQcUDF7kvYL7rhXNZTRdF3kE7nATu26Ptx7bkE76',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: 'AGuz7MeE9ExpmJRvpymtSZPXFmqBoBsrnA7N2JnRSCcs',
    serumBids: 'BcXYrKUHdt3FqPWzyTDmNKPhzG7g31HUVYtYHDeBRnf9',
    serumAsks: 'Fa2xPjcZuZzXZ4Zbk2BFe3xDx6GEVjURMLzWmJWhk1BC',
    serumEventQueue: 'EsMQz7vPAm6QF1DGAPrDH7FJGwhA77GxFPkxTh9RBFxm',
    serumCoinVaultAccount: 'BxmmTShv7KepUdEjwwPUtZ6KiW7seWG3e7vZNiKUQmxZ',
    serumPcVaultAccount: '45szw1d5YMkKcNN3CNWSRSEjwzmx1KKahnKXiTcgotCx',
    serumVaultSigner: 'YGLDRoqrLv8TeZZtjGbcxox1hZnJNqgnaf71ARZ765o',
    official: true
  },
  {
    "name": "weSHIB-USDC",
