...
export const LIQUIDITY_POOLS: LiquidityPoolInfo[] = [
  ...
  },
  {
    ...
    coin: { ...TOKENS.SLB },
    pc: { ...NATIVE_SOL },
    lp: { ...LP_TOKENS['SLB-SOL-V4'] },
    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: '7nePGGLXC8JXj2UYRqa9eToHEEWjpQAuoXh5HX5cRKt',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: 'FVSKJfGxs6uQXF6XwaXXeHTV1QsNMD9urCoY7HbfPo2X',
    ammTargetOrders: '7wGnTM2NbPBihaX3RFan3uyWpRSnzYwC7LoYJvbMJ9ax',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: '7LwsKiK5PLY4qQ32Wc7u4QWMM4e675dfVvcsAp2hTo6T',
    poolPcTokenAccount: 'HtgFVhvCV2mFjcx6LpFfEqRqZFKu6Ks3stnHTXqiUtfB',
    poolWithdrawQueue: '7zp6tZhBdehrtbtL8EHcwvynYWsB97rWZjXwEHPQm1wX',
    poolTempLpTokenAccount: 'DocZTNPxh7t4Ygc22s6S1Q5rGx5kmzHPmifw7yzLoVyF',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: 'GQk1KCwMn6SigfMjQ77Q6Mprgh4Qg54eijavDT31VJPZ',
    serumBids: 'J3ixJizd7surXQ7BJD6jGSB69Yd9FJHWQuQxk1fL5aF5',
    serumAsks: '7n153nUfSeGEduxidziJ3oCaJRmZWDmZak9oKBXhKuqE',
    serumEventQueue: 'Aa4Nbbap2g7FSmUV2obUes8vNKuKjzRz9WTnv4RjcGDU',
    serumCoinVaultAccount: '2peUN2jDx89jAMWAPRARwfmXJ8YCqogkaJ4ogZ8G1jKm',
    serumPcVaultAccount: '2GgduoEtVUWbJmm6wGXeV8AMoD5TEqk6xw4rGK4saqXN',
    serumVaultSigner: 'D2oMYFy8oJMYrSmsP4GDWGtPffgvQVzejvxQ5Ne5AYCo',
    official: true
  },
  {
    name: 'SLB-USDT',
    coin: { ...TOKENS.SLB },
    pc: { ...TOKENS.USDT },
    lp: { ...LP_TOKENS['SLB-USDT-V4'] },
    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: 'DYE2NPoUBxfTioWKYJVVDhE8NSDZMDrLEKgeQQe439rk',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: '8za1Koj6crNH8xeTMz7gFLUp1uw5evhiHvbMSTGPAbEG',
    ammTargetOrders: 'GLb7nWs4VpG3aqRNfJa6NYqcFh54HeEtGrfu3cbVEDMG',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: '9kkLJgNuH3d15BTFdiNZct6hUEF6Kb4LmzT6zFwqJ73A',
    poolPcTokenAccount: '9D6RguaNUnPJqKUm4fm62pYF3g3d8XDXMfgMfnQhr3o1',
    poolWithdrawQueue: 'H8gfNzXieYQY6nNSqAnendb69trZostoe94FbjcgqNDN',
    poolTempLpTokenAccount: 'BiAY5N6TuoBqJ7c6yVESu9jebnoPKfo5tfATk8FFRyUq',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: '7jbVj4hSWRM5vcf2riAojBBnERy6Fj4AobKA4VwLtEU5',
    serumBids: '4THfy6puvD57APPhZmGNc7U8q7PztvUsCQtM5bykRUhq',
    serumAsks: '3XmVphMQKiG4Q6MDo47pWMKxvgqmbk9iD481QNAwij2M',
    serumEventQueue: '2A4HpUFcL8t8janEeALhQPshUPahjCR4jLM5nyp7GVKH',
    serumCoinVaultAccount: '4FRrGkt1oomxmM33VFDck1ciENb437zXZiHnU124DBm4',
    serumPcVaultAccount: 'D3tHDdJZjVUdQX5DywJFBooqRpVS4hiDUb12VubTMx58',
    serumVaultSigner: 'Eh223BmDP9isAuJdC1XYRHN78hfUQoBvWgNLp8sZcWkd',
    official: true
  },
  {
    name: 'SLB-USDC',
    coin: { ...TOKENS.SLB },
    pc: { ...TOKENS.USDC },
    lp: { ...LP_TOKENS['SLB-USDC-V4'] },
    version: 4,
    programId: LIQUIDITY_POOL_PROGRAM_ID_V4,
    ammId: '21q4SsJ9kMh5UXp99EE3U2vKL6rNWS6KUPzjechumpLA',
    ammAuthority: '5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1',
    ammOpenOrders: 'BJq5ANVPTEVSsGu4P29NCenPGZvXhUdGpniTYSiSAELh',
    ammTargetOrders: 'E5hc51kEeNoqGGkf6sovkTyscRJn5S8PsCAL8kCKh9ao',
    // no need
    ammQuantities: NATIVE_SOL.mintAddress,
    poolCoinTokenAccount: '5MGmm1XGm9vA9dPSP1GcphkmmZC3ckXDF9wwgTjk1Vu',
    poolPcTokenAccount: 'BhhVSEAxt51WMEU1XzV1GdtNhyuY7R973rAJMp74CZjQ',
    poolWithdrawQueue: '49YsgChTRR41HEEp8nTs6oUKuo3hmfqeGoKvPSiHpZjd',
    poolTempLpTokenAccount: '54RLvecmSzhUa3dcwdrtNsDB6Rgppnp4ZXNW4wcMJgeC',
    serumProgramId: SERUM_PROGRAM_ID_V3,
    serumMarket: '4MUhHF5K9simSLXuaUKMaU8nMHSCRPzPMe7UtJRXi4HZ',
    serumBids: '2SrPZCNBYnBtxNERbCCiZTXExBkq8ZgMojwC31XhM9dC',
    serumAsks: '2aDPzY5yAS4FJ11ZNrwQXCKJA6XLPuMCpbpYgujtKYJ7',
    serumEventQueue: '6NoZy4vukadrqUWjQiAMovXBUAoaFwzQ1onHQTHSQgGP',
    serumCoinVaultAccount: 'HzYJRJVWc7YwURs51pyV28QDX8higLY5KbsfkFfyGBWx',
    serumPcVaultAccount: 'FmZKugMrhDYtBe9o4BtJT8kEqrqYSniSshX6XvTStBVz',
    serumVaultSigner: 'HTC8sXfqzVcwu7GhywQMsHN7W7mLWJgVgJ7G19GUg5AF',
  },
  {
    name: 'BOKU-USDC',
    coin: { ...TOKENS.BOKU },
