...
export const FARMS: FarmInfo[] = [
  ...
  },
  {
    ...
    poolId: 'ABBtgVwJFHCbvNi9JoEBHwNBLcbHzf8kYCMAEd2xjze5',
    poolAuthority: 'Aos3tsgPSRhzGEoAmZAiLeY8jFxQwAzikjRJEWaBAXR9',
    poolLpTokenAccount: 'EFBfJ7J45ZefPqRqswBXwtuYwajnEZMwxR9KiY1FKbut',
    poolRewardTokenAccount: 'Fdiav35ei1HkpgSmDTG5igPiSUF4tshRNuuW3KAsqSjn',
    poolRewardTokenAccountB: '5SAKfiRatUHCcCHMi6uxqAPuw4RvXFZAbrE8q8FzpYum'
  },
  {
    name: 'ATS-USDC',
    lp: { ...LP_TOKENS['ATS-USDC-V4'] },
    reward: { ...TOKENS.RAY },
    rewardB: { ...TOKENS.ATS },
    isStake: false,
    ...
    poolId: '8QAZXSY99fCxp9FRG9W5JL4uTkicx2C7KAaMumVKLpVA',
    poolAuthority: '542VDrLkDRGJPjREBaZR3NUXoKs1zJuVKNueDY8fb2aa',
    poolLpTokenAccount: 'CGXMtE4bMjzes5jtzJEiRAAvmdK2spq1aaf6ZThBKBFs',
    poolRewardTokenAccount: 'swUGv4QuivDJyUUgPinBseAV24mTzADEVRpCiSCNZz6',
    poolRewardTokenAccountB: '2Exk1S4bBovyuF3L4HV9FtVD64WFEouNzMiFoDyb6vNp'
  },
  {
    name: 'FLWR-USDC',
    lp: { ...LP_TOKENS['FLWR-USDC-V4'] },
    reward: { ...TOKENS.RAY },
    rewardB: { ...TOKENS.FLWR },
    isStake: false,
    ...
    poolId: '7jhxXfdepg7mxmRzU1T3Gpm4EKbmtgZ7oWBiGMh53Ykd',
    poolAuthority: 'Ehq2Lziqu1KsRdcamv4NqbUbqHtAVuLoNmupZdzazgP8',
    poolLpTokenAccount: '8PDTdDaGYwy7U2SsUy3j2avCk5j6CjXwxmSHy8HHjNjb',
    poolRewardTokenAccount: '9xFs8pJ7nvhxQZSW751acwzJJikE7QbnqycKcmQcUnHv',
    poolRewardTokenAccountB: '3kgHkd5xyM9bFbsGgis3JqGtMzG4mDE2XSLAG7CgjFwo'
  },
  {
    name: 'ROLL-SOL',
    lp: { ...LP_TOKENS['ROLL-SOL-V4'] },
    reward: { ...TOKENS.RAY },
    rewardB: { ...TOKENS.ROLL },
    isStake: false,
    ...
    poolId: 'BYRs8rwnXBJYf23M4BJ4SYW2zjJvVrsgwDezWSF9qju9',
    poolAuthority: 'E9CRhiCdFz9A7mi9YaXvBG4kGrJqofx8Am9XYjEdL83Q',
    poolLpTokenAccount: '42oqJAKQ3PvTXuYzC9gK3f2UNGre5JnCzBGe1LCDfrM6',
    poolRewardTokenAccount: '3MJ3hAQKkDTpWR5nMtJZVNkPUaXCZy6jjpnDyRLSxt8C',
    poolRewardTokenAccountB: 'Cfrn1mdxWWeS8QBy4uuAjo7kmcCas7mQoh6uxQ4BN9SR'
  },
  {
    name: 'ROLL-USDC',
    lp: { ...LP_TOKENS['ROLL-USDC-V4'] },
    reward: { ...TOKENS.RAY },
    rewardB: { ...TOKENS.ROLL },
    isStake: false,
    ...
    poolId: '7YoBkrmXJnUqrC54HK16mCavowFNCFf8hNiV7GwfVXQU',
    poolAuthority: 'EY1aZ1jq1FpqtmyDMfPqfTRxXpXVr4BfkyWVBobvdc3y',
  ...
  {
    name: 'SEEDED-USDC',
    lp: { ...LP_TOKENS['SEEDED-USDC-V4'] },
    reward: { ...TOKENS.RAY },
    rewardB: { ...TOKENS.SEEDED },
    isStake: false,
    ...
    poolId: '6HcktBcbpue4N41AoGv8zndKRkPPkLVcWeULjobB9NrE',
    poolAuthority: '6GBPs5u5Hvoo7TxP8D4L5TzDrQDeEthKYNyWGGhdkV9k',
    poolLpTokenAccount: '3DKR11sq7hBuCPARSYBZaw9XEarvRUC94Wc3fmfy3kCq',
    poolRewardTokenAccount: '5rUKyj9z8ZgCxeaT7G2E98HH8EGW47btCG2xykEgArXq',
    poolRewardTokenAccountB: '9Yt9XqbAvQPQnCawwfSCPbVD8ntEnkENVDwuDu3DnYg2'
  },
  {
    name: 'PUFF-USDC',
    lp: { ...LP_TOKENS['PUFF-USDC-V4'] },
    reward: { ...TOKENS.RAY },
    rewardB: { ...TOKENS.PUFF },
    isStake: false,
    ...
    poolId: '68sMPVDR2PvJnYkLCQnKD3g7zvxqEUvJ1Ws1kj8BvdKU',
    poolAuthority: '4zn6X4aLNjUvMx6hYKTxG1Zw9ixYTdTWvJSrDw6JK8rJ',
  ...
  },
  {
    ...
    poolId: '5oCZkR2k955Mvmgq3A4sFd76D5k4qZn45VpaCkp8H3uS',
    poolAuthority: 'EPAFdt4SkxUAq1QMJgaZZ4ouCDaisrUJJddhZRGPxHXU',
    poolLpTokenAccount: 'DduzAhNLsqaeSno9aELfZ8TqtWh9c4kyTGRwxK4JaBw2',
    poolRewardTokenAccount: 'DpjXRkiQEBXqLh8jpHZZRztwEej1GarxVvpBi1SR8rKk',
    poolRewardTokenAccountB: '6fomjaXLVgTbTaQLGRnKsJGBJ4Rt556v6NhynWDnrb5u'
  },
  {
    name: 'YAW-USDC',
    ...
    poolId: 'E1cnHvk2sLkhKdfd2EDaQyhG3e7Efqj127FJDSo4vZuz',
    poolAuthority: '4aFq5wVyV46aJ7uFwHwDzMSL7vRqqcSJKrdRPiUJaktV',
    poolLpTokenAccount: '5F9dJJVVqaEpjqgcBGapfiDZ8ie2yxJKor1gmqmNpRvV',
    poolRewardTokenAccount: '27N3RxvYb6KA8EtuJubeBBAn8dG6UqWGYasGt22QRGWv',
    poolRewardTokenAccountB: '446S42ecEzfoaqmcacn2cN2mywvKZJWyBdBfQ22JaVbi'
  },
  {
    name: 'ZBC-USDC',
    ...
    poolRewardTokenAccount: 'Fh4R78nzYTWrwBkieuAWQ7cDimu8UDhukdUqbrpy3Zeq',
    poolRewardTokenAccountB: '6cdrE6aSip66vmeXeg9iJMLrJWdrEVqkHNygAxoL7n7c'
  },
  {
    name: 'UM-USDC',
    lp: { ...LP_TOKENS['UM-USDC-V4'] },
    reward: { ...TOKENS.RAY },
    rewardB: { ...TOKENS.UM },
    isStake: false,
    ...
    poolId: 'HsCu8MR3vHcr2QbKGGnrn6Bo8dcFzFAugqdV9wVJXcFV',
    poolAuthority: 'GEg83ihoLeswkmAFrxnvbGB8xWRw6Ba1oKvkhxAP9V3r',
  ...
  },
  {
    ...
    poolId: '5Eu1PH2p8ScdbbpKxUEqzCMzNnVzpQCiVUKrp8kZsGoW',
    poolAuthority: 'C86xzN4AHHkN8TTdtvBJMbrcTNE57LyPusF47sMC39u1',
