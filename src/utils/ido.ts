...
export const IDO_POOLS: IdoPool[] = [
  {
    ...
    price: new TokenAmount(0.021, TOKENS.USDC.decimals, false),
    raise: new TokenAmount(1050000, TOKENS.ZBC.decimals, false),
    ...
    isRayPool: true,
    isPrivate: false,
    idoId: '3dzFshf1hTJ4xLt8uG87cGFA3fzBmUtT1hoVFc3vNPbN',
    baseVault: 'DoGu2pNFFwjMaQYnkMcEz8GKTBSPPbJkCwgEw2o2KvWV',
    quoteVault: 'BYMo31vjmaDWYWVs3j364XDeXRssYgwbnqXZi3wMeUz2',
    seedId: 'As7Qo4axkCLULMSJcRb88Hd944LtoJgppR5EcPapM66x'
  },
  {
    base: { ...TOKENS.YAW },
    quote: { ...TOKENS.USDC },
    ...
    raise: new TokenAmount(50000000, TOKENS.YAW.decimals, false),
  ...
  },
  {
    ...
    price: new TokenAmount(0.002, TOKENS.USDC.decimals, false),
    raise: new TokenAmount(250000000, TOKENS.FCON.decimals, false),
    ...
    isRayPool: true,
    isPrivate: false,
    idoId: '3Ebtuv5yEqMGLFXmt1eESwCa28pkwnkJXKr1FxrvLtiV',
    baseVault: '7Xexuz32nhfz867i5eFtCTCuHAyUFZsoqh1fzuybetxQ',
    quoteVault: 'FXWB1tERoJPqHZGqz8L6pn9d1bXeVBxK9ijuX8JTLWt2',
    seedId: 'HRv8kW1iHgufMwNC9XjfNFqkh679CeZmsUi8NndgZrQ2'
  },
  {
    base: { ...TOKENS.REAL },
    quote: { ...TOKENS.USDC },
  ...
  },
  {
    ...
    price: new TokenAmount(0.1, TOKENS.USDC.decimals, false),
    raise: new TokenAmount(10000000, TOKENS.TTT.decimals, false),
    ...
    isRayPool: true,
    isPrivate: false,
    idoId: '6vr62dLQL1Cwc8gP5RvPUqQ1JxAeP5kDayzghfLbCo7A',
    baseVault: 'DDAP7hw4uvy8JudwhjM8tH8pfpnM5vpeAuAu4FUz7gXG',
    quoteVault: 'HgS6LxpsaxUepTdiz8i9jBrGhadaFyDx9cwso5P825rg',
    seedId: '4Z1jpanh6irMnQ2BS2dAD8mbxeZVRFxzjuEG3vUWLu8r'
  },
  {
    base: { ...TOKENS.DFL },
    quote: { ...TOKENS.USDC },

    price: new TokenAmount(0.005, TOKENS.USDC.decimals, false),
    raise: new TokenAmount(70000000, TOKENS.DFL.decimals, false),
    ...
    isRayPool: true,
    isPrivate: false,
    idoId: 'DTfvaFt5bZiS1Ak8S7dbviTvj5Gwamb4NZewV1prdPzN',
    baseVault: '5VKAhVUyqdppFdp5cdMAhifMYbA2rKSFhSNWLJPyUJPk',
    quoteVault: '7fPNyszoEwrT81vdFPATi1f6wBEcx17ycvPEgGGf6T1z',
